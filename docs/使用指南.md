...
mkdir -p ~/.claude && cat > ~/.claude/settings.json << 'EOF'
{
  "env": {
    ...
    "ANTHROPIC_BASE_URL": "http://127.0.0.1:15288",
...
- `http://127.0.0.1:15288` 是代理服务的默认地址，如果修改过端口请相应调整
...
![透传模式](pic/3_0_添加配置_透传模式.png)

![覆盖模式](pic/3_1_添加配置_覆盖模式.png)

![映射模式](pic/3_2_添加配置_映射模式.png)
