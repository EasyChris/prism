          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">代理服务当前运行在 127.0.0.1:3000</div>
              </div>
              <button className="px-4 py-2 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors">
                运行中
              </button>
            </div>
          </div>
